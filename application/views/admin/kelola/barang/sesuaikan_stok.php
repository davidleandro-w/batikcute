<div class="container-fluid card col-md-3">
    <?php echo form_open('admin/kelola/stok_sync/' . $barang->id_brg) ?>
    <div class="card-header text-center">
        <label for="stok" class="control-label h5 font-weight-bold text-success"><span class="text-danger"></span>Sesuaikan Perubahan Stok</label>
